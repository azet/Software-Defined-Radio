...
**
** Created: Sat Oct 13 16:18:49 2012
**      by: The Qt Meta Object Compiler version 63 (Qt 4.8.2)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../gqrx/qtgui/plotter.h"
...
static const char qt_meta_stringdata_CPlotter[] = {
    "CPlotter\0\0f\0NewCenterFreq(qint64)\0"
    "freq,delta\0NewDemodFreq(qint64,qint64)\0"
    "NewLowCutFreq(int)\0NewHighCutFreq(int)\0"
    "low,high\0NewFilterFreq(int,int)\0"
};
...
const QMetaObjectExtraData CPlotter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CPlotter::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_CPlotter,
      qt_meta_data_CPlotter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CPlotter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CPlotter))
